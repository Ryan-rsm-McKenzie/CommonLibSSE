...
namespace RE
{
	...
	ScrapHeap* MemoryManager::GetScrapHeap()
	{
		using func_t = decltype(&MemoryManager::GetScrapHeap);
		REL::Offset<func_t> func(Offset::MemoryManager::GetScrapHeap);
		return func(this);
	}
	...
	{
		using func_t = decltype(&MemoryManager::Malloc);
	...
	{
		using func_t = decltype(&MemoryManager::Realloc);
