...
namespace SKSE
{
	...
	public:
		...
		template <class F> bool Write5Branch(std::uintptr_t a_src, F a_dst) { return Write5Branch(a_src, unrestricted_cast<std::uintptr_t>(a_dst)); }
		template <class F> bool Write5Call(std::uintptr_t a_src, F a_dst) { return Write5Call(a_src, unrestricted_cast<std::uintptr_t>(a_dst)); }
