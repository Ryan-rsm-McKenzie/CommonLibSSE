...
namespace RE
{
	...
	public:
		...
		void                    Unk_C4() override;                                                      // 0C4 - { unk272 = a_arg1; }
		void                    Unk_C5() override;                                                      // 0C5 - { return unk272; }
		void                    Unk_C6() override;                                                      // 0C6 - { return 1; }
		void                    OnArmorActorValueChanged() override;                                        // 0CA
		void                    Unk_D7() override;                                                      // 0D7
		void                    Unk_D9() override;                                                      // 0D9
		void                    Unk_E6() override;                                                      // 0E6 - calculate armor rating?
		void                    Unk_E7() override;                                                      // 0E7 - something about armor rating
		void                    Unk_E8() override;                                                      // 0E8 - get unarmed damage?
		void                    PrecacheData() override;                                                // 120

		// add
		virtual void Unk_128();  // 128
		virtual void Unk_129();  // 129 - { return 1; }
	};
