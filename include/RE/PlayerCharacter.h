...
namespace RE
{
	...
	public:
		...
		STATIC_ASSERT(sizeof(CrimeStats) == 0x10);


		struct StealCrimeStats
		{
			SInt32	unwitnessed;	// 0
			SInt32	witnessed;		// 4
		};
		STATIC_ASSERT(sizeof(StealCrimeStats) == 0x8);
		...
		UInt32										unk3D8;						// 3D8
		UInt32										unk3DC;						// 3DC
		BSTHashMap<TESFaction*, CrimeStats>			crimeMap;					// 3E0
		BSTHashMap<TESFaction*, StealCrimeStats>	stealCrimeMap;				// 410
