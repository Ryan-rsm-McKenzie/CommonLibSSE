...
namespace RE
{
	...
	namespace BSScript
	{
		...
		template <class T> struct vm_type : _vm_type<remove_cvpr_t<T>> {};
		...
		template <class T> struct is_vm_array : _is_vm_array<std::remove_cv_t<T>> {};
		...
		template <class T> struct is_vm_form_array_no_cvr : is_vm_form_array<remove_cvr_t<T>> {};

		template <class T> struct is_vm_builtin_array : std::conjunction<is_vm_array<T>, is_builtin_type<remove_vm_array_t<T>>> {};
		template <class T> struct is_vm_builtin_array_no_cvr : is_vm_builtin_array<remove_cvr_t<T>> {};
