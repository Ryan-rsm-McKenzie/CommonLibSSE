...
namespace RE
{
	...
	public:
		...
		virtual void					InitLoadGame(void* a_arg1) override;			// 010 - { Actor::InitLoadGame(a_arg1); }
		virtual void					FinishLoadGame(void* a_arg1) override;			// 011 - { Actor::FinishLoadGame(a_arg1); }
		virtual void					Revert(void* a_arg1) override;					// 012 - { return; }
		...
		virtual void					InitiateVampireFeedPackage(void) override;		// 0C0
