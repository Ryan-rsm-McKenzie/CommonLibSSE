...
namespace RE
{
	namespace BSResource
	{
		...
		public:
			...
			virtual ErrorCode	DoCreateStream(const char* a_path, BSTSmartPointer<Stream>& a_stream, Location*& a_location, bool a_createFile, LocationTraverser* a_traverser) = 0;	// 03
			virtual ErrorCode	DoCreateAsyncStream(const char* a_path, BSTSmartPointer<AsyncStream>& a_out, Location*& a_location, bool a_createFile, LocationTraverser* a_traverser);	// 04 - { return ErrorCode::kUnsupported; }
