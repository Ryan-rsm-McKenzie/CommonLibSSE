...
namespace RE
{
	...
	namespace Impl
	{
		inline void CalcCRC32_32(UInt32& a_crc32, UInt32 a_data)
		{
			using func_t = function_type_t<decltype(&CalcCRC32_32)>;
			REL::Offset<func_t*> func(Offset::CRC32Calculator::SizeOf32);
			func(a_crc32, a_data);
		}


		inline void CalcCRC32_64(UInt32& a_crc32, UInt64 a_data)
		{
			using func_t = function_type_t<decltype(&CalcCRC32_64)>;
			REL::Offset<func_t*> func(Offset::CRC32Calculator::SizeOf64);
			func(a_crc32, a_data);
		}


		inline void CalcCRC32_SIZE(UInt32& a_crc32, const void* a_data, UInt32 a_size)
		{
			using func_t = function_type_t<decltype(&CalcCRC32_SIZE)>;
