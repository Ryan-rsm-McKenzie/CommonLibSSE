...
namespace RE
{
	...
	public:
		...
		virtual void                              Unk_67();                                                                                                                                                                                                // 67 - { return; }
		virtual void                              Unk_68();                                                                                                                                                                                                // 68 - { return; }
		virtual void                              Unk_69();                                                                                                                                                                                                // 69 - { return; }
		...
		virtual bool                              PopulateGraphProjectsToLoad() const;                                                                                                                                                                     // 72
		virtual NiPoint3                          GetBoundMin() const;                                                                                                                                                                                         // 73
		virtual NiPoint3                          GetBoundMax() const;                                                                                                                                                                                         // 74
		virtual void                              Unk_75();                                                                                                                                                                                                // 75 - { return 0; }
		...
		virtual void                              Unk_8B();                                                                                                                                                                                                // 8B - { return 0; }
		virtual void                              Unk_8C();                                                                                                                                                                                                // 8C - { return; }
		...
		virtual void                              Unk_94();                                                                                                                                                                                                // 94 - { return; }
		virtual void                              Unk_95();                                                                                                                                                                                                // 95 - { return; }
		virtual void                              Unk_96();                                                                                                                                                                                                // 96 - related to lockpicking
		...
		virtual void                              Unk_9C();                                                                                                                                                                                                // 9C
		virtual void                              Unk_9D();                                                                                                                                                                                                // 9D - { return 0; }
