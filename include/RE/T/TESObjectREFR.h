...
namespace RE
{
	...
	public:
		...
		float									GetHeadingAngle(const NiPoint3& a_objPos, bool a_absolute = true) const;  //If "a_abs == false"(Not return absolute value), heading angle will be positive when clockwise, and negative when counter clockwise.
