...
template <class Int, typename std::enable_if_t<std::is_integral<Int>::value && sizeof(Int) == sizeof(SHORT), int> = 0>
...
template <class Int, typename std::enable_if_t<std::is_integral<Int>::value && sizeof(Int) == sizeof(LONG), int> = 0>
...
template <class Int, typename std::enable_if_t<std::is_integral<Int>::value && sizeof(Int) == sizeof(LONG64), int> = 0>
